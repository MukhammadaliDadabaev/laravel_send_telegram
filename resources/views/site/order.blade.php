    ...
    <div class="container">
        ...
        <form action="{{ route('order.store') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" id="fio" aria-describedby="emailHelp"
                    placeholder="Дмитрий Повышев">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Email</label>
                <input type="email" class="form-control" name="email2" id="exampleInputEmail1"
                    aria-describedby="emailHelp" placeholder="dima@yandex.ru">
            </div>
            <div class="form-group">
                <label>Товар</label>
        ...
        {{-- <div>
            <form action="#" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="text" id="fio"
                        aria-describedby="emailHelp" placeholder="Test">
                </div>
